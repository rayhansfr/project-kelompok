  ...
  return (
    <div className="grid grid-cols-1 grid-rows-2 ">
      <div className="grid h-screen w-full text-center content-center">
        <h1 className="text-4xl font-bold ">Galery</h1>
        <h4 className="text-sm text-neutral-500">Community</h4>
      </div>

      <div className="grid h-screen w-full text-center content-center ml-5">
        <p className="text-4xl font-bold mb-5 text-left">Contact Us</p>
      <form className="w-full max-w-lg">
          ...
          <div className="flex flex-wrap -mx-3 mb-2">
            <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
              ...
              <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-province" defaultValue={"DKI Jakarta"} disabled/>
            </div>
            <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
              ...
              <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="Your ZIP Code"/>
            </div>
          </div>
        </form>
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-1 mt-5"
          type="submit"
          style={{minWidth: "8rem"}}
        >
          Submit
